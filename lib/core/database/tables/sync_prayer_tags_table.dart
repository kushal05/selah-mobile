...
/// Prayer-Tag junction table for sync-enabled database
///
...
///
/// Replaces the tags stored as JSON in the prayer `category` metadata field.
class SyncPrayerTags extends Table {
