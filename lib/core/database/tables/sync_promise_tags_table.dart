...
/// Promise-Tag junction table for sync-enabled database
///
...
///
/// Replaces the comma-separated tags stored in the promise `category` field.
class SyncPromiseTags extends Table {
